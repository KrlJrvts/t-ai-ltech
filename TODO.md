# TODO — agent stack roadmap

## Phase 1: Foundations (v0.2.0)
  - [x] Rename to agent stack
...
## Phase 3.6: Visual PR Annotations + S3 Upload
  - [ ] `/setup-upload` skill (configure S3 bucket for image hosting)
  - [ ] `browse/bin/upload-helper` helper (upload file to S3, return public URL)
